...
<sup>I</sup> . Princípio de DEDEKIND: _se o conjunto dos reais é dividido em duas classes não vazias X e Y e disjuntas, de maneira que para x e X e_ y £ Y _arbitrários se cumpra_ x < y , _existe, então um único número_ a _para o qual_ x < a < y , _quaisquer que sejam_ x **G** X e y **G** Y.
