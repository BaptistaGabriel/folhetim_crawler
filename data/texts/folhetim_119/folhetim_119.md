...
1) Na janela principal, o menu *Janela* desdobra uma caixa de opções, onde devemos selecionar a opção 2-dim

![](_page_2_Picture_12.jpeg)

- 2) Uma vez escolhida tal opção, abre-se uma janela gráfica.
- 3) Juntamente com a janela gráfica, aparece também uma janela *inventário*, na qual estão os comandos relativos ao gráfico.

![](_page_2_Figure_15.jpeg)

4) Na janela gráfica, o menu desdobrável *Equação* permite selecionar o tipo de equação a ser usada, que no caso em estudo será a *Implícita*.

![](_page_3_Picture_1.jpeg)

5) Na janela *curva implícita*, escrevemos a equação (VII), usando os parâmetros a e b em substituição a  $x_0$  e  $y_0$ , respectivamente, por questão de conveniência.
