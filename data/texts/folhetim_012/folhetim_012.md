...
$\sqrt{a}\cdot\sqrt{b}=\sqrt{ab};\ a,b\in\mathbb{Z}^{+}$
...
este resultado é compatível com o Teorema Fundamental da Álgebra: toda equação polinomial f(x) = 0, tem pelo menos uma raiz, sejam os coeficientes reais ou imaginários.
