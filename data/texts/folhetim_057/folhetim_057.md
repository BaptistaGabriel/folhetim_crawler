...
O espinho protege a rosa com carinho.
...
1. Sabe-se que $\sqrt{a} \cdot \sqrt{b} = \sqrt{ab}$ . Exemplificando: $\sqrt{5} \cdot \sqrt{7} = \sqrt{35}$ . Consequentemente: $\sqrt{-1} \cdot \sqrt{-1} = \sqrt{(-1) \cdot (-1)} = \sqrt{1} = 1$ Mas, sabemos que: $\sqrt{-1} = i$
