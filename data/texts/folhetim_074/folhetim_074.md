...
**1^ Pergunta.** Muitos leitores perguntam o *"porquê"*  de certas *"convenções"* em matemática. Por exemplo: eles querem saber, por que O! = 1 (fatorial de zero igual a 1). Pela lógica, segundo eles, deveria ser O! = 0. Outros perguntam a razão da famosa *"regra dos sinais* " e assim por diante.
...
n! = 1.2.3. •••.n, *n ^ O, o* que equivale a afirmar que n! = (n-l)!n. Assim: 5! = 1.2.3.4.5 = 4!.5 = 120. Se defmíssemos O! = O, a fórmula acima (a definição de fatorial de um número n) para n = 1, daria:
