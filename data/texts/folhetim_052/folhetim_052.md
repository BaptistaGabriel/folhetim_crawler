...
Lembramos também a você que a partir do número 54, apenas aqueles que nos devolveram a ficha de avaliação anexa ao número 48, receberão o _Folhetim_. Isso vale apenas para os leitores cadastrados até setembro de 1996.
...
(i)$a^{0}: a^{n} = 1: a^{n} = a^{-n}, a^{0}: a^{n} = a^{0-n} = a^{-n};$
