...
No próximo número, estaremos divulgando uma lista das perguntas enviadas até este número, para a coluna _Pergunte que o NEMOC Responde._ Aguardem!
...
**2" Pergunta.** Alice B. P. dos Santos, de Belo Horizonte indaga: _Pode uma equação algébrica_ _de grau n, possuir um número de raízes superior a n?_
...
w = a^ **-I-** aj i **-f-** a^ j **-I-** a^ k, onde a^, a^, a^, _SL^_ são números reais arbitrários. Deve-se observar o seguinte:
...
_Perguntas publicadas nos Folhetins anteriores._
