...
**1^ Pergunta.** Max Denis de L. Santos, Conjunto Rui Palmeira, B1-2A, Apt° 404, Maceió (Serraria), escreve: _"certa vez, lendo um livro de matemática, vi uma maneira muito interessante de resolver uma equação do 1° grau com uma incógnita. Acho fantástico esse método e peço uma explicação"._
...
- •Álgebra Linear aplicada ao _2°_ grau - **45** h
...
pág. 3, _Pergunte que o NEMOC Responde, T_ coluna, onde se lê ÃC +BC^= d < ÃB , leia-se ÃC + BC = d>ÃB.
