...
| Margem Esquerda | Direção | Ação (Quem atravessa) | Margem Direita |
| :--- | :---: | :---: | :--- |
| A, B, C, c | $\rightarrow$ | a, b | b |
| A, a, B, C, c | $\leftarrow$ | a | |
| B, C, c | $\rightarrow$ | A, a | b, a |
| A, B, C, c | $\leftarrow$ | A | |
| A, B | $\rightarrow$ | C, c | C, c |
| A, a, B, b | $\leftarrow$ | a, b | |
| B, b | $\rightarrow$ | A, a | C, c, A |
| a, B, b | $\leftarrow$ | a | |
| a | $\rightarrow$ | B, b | B, b, C, c, A |
| A, a | $\leftarrow$ | A | |
| | $\rightarrow$ | A, a | A, a, B, b, C, c |
