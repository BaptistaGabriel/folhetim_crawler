...
1\* Pergunta. Um colega de Salvador indaga: Sabemos que  $x + 2 = \frac{x^2 - 4}{x - 2}$ . Minha pergunta é a seguinte: devido ao mencionado logo acima, eu posso, claramente, escrever que  $x + 2 = x^2 - 4 \cdot \frac{1}{x - 2}$ ; logo, posso afirmar que x + 2 foi fatorado, tendo como fatores  $x^2 - 4$  e  $\frac{1}{x - 2}$ ?
