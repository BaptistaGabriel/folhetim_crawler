...
Considere as transformações rígidas do plano. Como sabemos elas formam um Grupo. As propriedades geométricas estudadas na _geometria euclidiana_ são aquelas que não alteram-se pela ação desse grupo, como
...
AB e BC e, igualmente, a razão AB/BC. Agora, para quatro pontos A, B, C, D sobre uma reta e suas projeções A', B', C', D' sobre outra reta, existirá um notável invariante denominado de _razão anarmônica_ dos quatro pontos.
