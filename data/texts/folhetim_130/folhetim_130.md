...
Alguns avaliações sobre os Elementos de Euclides
...
- A<sub>1</sub> Coisas iguais à mesma coisa são iguais entre si.
- A<sub>2</sub> Adicionando-se iguais a iguais, as somas são iguais.
...
a) distinção entre axiomas e postulados. Para Euclides, os A<sub>i</sub> acima, por fazer referência, às "noções comuns" eram mais gerais do que os P<sub>i</sub> acima que fazem referência apenas à matemática. Modernamente, trata-se
...
No ensino da matemática muitas vezes empregamos a análise como instrumento inventivo, reservando ao método sintético para a exposição dos diversos tópicos ensinados.
...
Envie para cada folhetim um selo de posta gem nacional de 1º porte. Dentro de no máximo quatro semanas, contadas a partir da data de recebi mento do seu pedido, você estará recebendo o folhetins solicitados.

OBS.: É permitida a reprodução total ou parcia deste folhetim, desde que citada a fonte.