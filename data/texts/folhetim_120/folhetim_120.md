...
Com uma pequena alteração, fixando  $x_0$  = -1,0, obteremos cissóides *oblíquas crunodais*, passando pela cissóide *reta crunodal* 

![](_page_1_Figure_9.jpeg)

3) Fixamos p = -2.0 e variamos  $x_0$  (que é igual a  $y_0$ ).

Para melhor manipulação no **Winplot**, editamos a janela da equação, escrevendo a expressão da equação (VII-c). Isso permite trabalhar com apenas uma janela de parâmetros, no caso *a*.
